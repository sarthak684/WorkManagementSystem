...
const TaskDetail = ({ navigation, route }) => {
    ...
    const [progressWidth,setProgressWidth]=useState(0.9)
    ...
    const PushNot = async (data) => {
      ...
      {
          const Notifications = await getNotifications(todayDateString);
          // console.log('------------------------------------------------------DataTasks:',DataTasks);
      ...
      addNotifications(todayDateString, object)
        ...
        if(index===0)
        {
            return(
                <View style={[styles.renderComments,]}>
                    ...
                    <View style={{ width:"88%",paddingLeft:'1.5%'}}>
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, }} >
            <View style={styles.container}>
                ...
                <View style={{ width: '90%', alignSelf: 'center', flexDirection: 'row', marginTop: 15, alignItems: 'center', justifyContent: 'center' }}>
                    <Progress.Bar progress={progressWidth} width={width * 0.81} color='#03c350' borderColor="grey" style={{ marginTop: 13 }} />
                    <Text style={styles.text6}>{progress}</Text>
                </View>
                ...
                <View style={styles.butview}>
                    ...
                    {
                        butt1 ? (
                            <TouchableOpacity style={styles.markcomplete1} onPress={but1} >
                                <Text style={{ color: 'grey', fontSize: 12 }}>Mark complete</Text>
                            </TouchableOpacity>
                        ) : (
                            <TouchableOpacity style={styles.markcomplete2} onPress={but1new} >
                    ...
                    {
                        butt2 ? (
                            <TouchableOpacity style={styles.inreview1} onPress={but2} >
                                <Text style={{ color: 'grey', fontSize: 12 }}>In Review</Text>
                            </TouchableOpacity>
                        ) : (
                            <TouchableOpacity style={styles.inreview2} onPress={but2new} >
                    ...
                    {
                        butt3 ? (
                            <TouchableOpacity style={styles.overdue1} onPress={but3}  >
                                <Text style={{ color: 'grey', fontSize: 12 }}>Overdue</Text>
                            </TouchableOpacity>
                        ) : (

                            <TouchableOpacity style={styles.overdue2} onPress={but3new} >
                                <View style={{ flexDirection: 'row' }}>
                                    <AntIcon6 name="check" size={20} color="white" />
            ...
            />
            {
                item.comments.length>1 ? 
                    <TouchableOpacity onPress={()=>setSeemore(!seemore)} style={{alignSelf:'center', width:'87%', paddingLeft:'12%', marginTop:'-2%'}} >
                    { 
                        seemore === true ? <Text style={{color:red, fontSize: RFValue(10)}} >See Less</Text> : 
                                        <Text style={{color:red, fontSize: RFValue(10)}} >See More</Text>
                    }
                    </TouchableOpacity> :
                    <></>
            }
