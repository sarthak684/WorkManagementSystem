...
const TodayTask = ({navigation, route}) =>
{
    ...
    // console.log('=====filteredData TodayTask: ',filteredData);
    console.log('=====todaytaskdata TodayTask: ',todaytaskdata);
    ...
    return(
        <View style={styles.containor} >
            ...
            <FlatList
                        data={ todaytaskdata.filter((task,index)=> task.date===todayDateString ) }
                        renderItem={({index,item})=>renderItem({index,item})}
                        keyExtractor={ item=> item.id }
                        extraData={ todaytaskdata.filter((task,index)=> task.date===todayDateString ) }
            />
            </View>
        </View>
    )
